...
log_mod <- h2o.glm(x = colnames(train.h2o)[-c(1, 50)], 
                   ...
                   family = "binomial",
                   interactions = c( 'ps_calc_06', 'ps_calc_13',  'ps_calc_04', 'ps_calc_14', 'ps_ind_15', 'ps_calc_07', 
...
After adding weights and couple of interaction variables the submission score remains at .260
...
```{r}
aml_model <- h2o.automl(x = colnames(train.h2o)[-c(1, 50)], y = "target", 
               training_frame = train.h2o,
...
fwrite(submission_data, "glm_model_weight.csv", row.names = FALSE)
```
