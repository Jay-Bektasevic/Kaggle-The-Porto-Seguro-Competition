...
We see a slight improvement in **AUC** and **Gini** but not enough to beat the highest score of **0.273**. It is interesting to see that after taking out insignificant variables that the model actually performs better. Furthermore, the time to train the model improves significantly. At this point, I will use this as my final model for this competition. I do not feel that I can do better without more insight into the dataset, or come up with a better feature engineering.
